...
def hangman():
    ...
    while restart_var:
        ...
        def soloPlay():
            random_word_list = ['COMPUTER','PYTHON','CODING','KEYBOARD','MOUSE','MONITOR','TELEVISION','POPCORN','BURGER','MUSIC','HANGMAN','FOOTBALL','TELEPHONE','SMARTPHONE','CAMERA', 'BOXING', 'SCHOOL', 'CUTLERY','JOGGING']
